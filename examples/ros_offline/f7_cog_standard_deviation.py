...
def calculate_cog_median_absolute_deviation(list_of_particles):
    ...
    """
    # Reuse calculate_cog_median to get the median distance
...
def plot_particles(list_of_particles):
    ...
    # Calculate and plot closest particle to COG
    min_distance, closest_particle = cog_min_dist(list_of_particles)
    if closest_particle:
        plt.plot([cog['x'], closest_particle[0]], [cog['y'], closest_particle[1]], linestyle='--', color='orange', label='Min Distance')
        plt.scatter(closest_particle[0], closest_particle[1], color='orange', edgecolors='black', s=150, label='Closest Particle')
...
min_distance = cog_min_dist(list_of_particles)[0]
print(f"The minimum distance from a particle to the center of gravity is: {min_distance}")
cog_mean = calculate_cog_mean(list_of_particles)
...
cog_standard_deviation = calculate_cog_standard_deviation(list_of_particles)
print(f"The standard deviation of distances to the COG mean is: {cog_standard_deviation}")
