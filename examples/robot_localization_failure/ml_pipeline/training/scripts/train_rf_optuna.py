...
def compute_class_weights(y):
    """Compute simple class weights for imbalance handling."""
    positives = y.sum()
...
def build_model(params: dict, class_weight):
    """Construct a RandomForest classifier with shared defaults."""
...
def main():
    ...
    # ============================================================
    scaler = fit_scaler(X_train, model_type="rf")  # returns None
